...
def prerequisiteCourses(courses, prerequisites): # Time, Space Complexities: O(V + E), O(V + E)
    ...
    while queue:
        ...
        #For each course that depends on curr, decrement its in-degree
...
class Test:
    def run_tests(self):
        #Test Case: Computer Science curriculum
        ...
        # Test Case: Literature curriculum (Multiple valid orders)
